...
import  os,sys
sys.path.append( os.path.abspath(os.path.join(os.path.dirname(__file__),'..')) ) # because models.py file is up a directory layer.
import models
...
POSTS = [
    ...
    {
        "title": "Mahin Ahmad  Has the Best YouTube Tutorials!",
