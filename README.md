...
<img width="861" height="501" alt="blog-webapp-architecture" src="https://github.com/user-attachments/assets/7d1bbf29-4ca3-448b-8ba5-536ab0f84b37" />

### DIY
1. download main branch and run `uv run fastapi dev main.py`
